...
ajaxUtils.sendGetRequest = 
  function(requestUrl, responseHandler) { //requestURL: the link where we are requesting to get the resource
    ...
    request.onreadystatechange = //onreadystatechange is a stage in the network communication between the server and browser
      function() { 
        handleResponse(request, responseHandler); //actually handle it (once server gives response)
