...
for (var i = 0; i < names.length;i++) {
	console.log("Hello " + names[i]);
} //".length" is 101, even though there is nothing stored in earlier items!


// // Arrays Pt. 2
var names2 = ["Erik", "Yack", "YoYo"];
var myObj = {
	name:"Erik",
	course:"HTML/CSS/JS",
	platform:"Coursera"
};
for (var prop in myObj) { //prop is a special term for the properties in the object
...
for (var name in names2) {
	console.log("Hello " + names2[name]);
} //Since an array is an object, it will keep looping over the properties and say "Hello Hi!"
